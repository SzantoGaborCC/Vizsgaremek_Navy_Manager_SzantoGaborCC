...
ALTER TABLE public.ship_class ADD CONSTRAINT ship_class_hull_classification_fk FOREIGN KEY (hull_classification_id) REFERENCES hull_classification(id) ON DELETE CASCADE ;